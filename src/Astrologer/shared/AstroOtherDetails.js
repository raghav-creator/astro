        ...
        <section className='my-5'>
          ...
          <div className='row mt-5 justify-content-center gap-3'>
            <div className='col-md-4'>
              <Button variant="lightgray" className=' w-100 astroRegisterBtn' onClick={() => navigate('/astroDetails')}>Back</Button>
            </div>
            <div className='col-md-4'>
              <Button variant="danger" className=' w-100 astroRegisterBtn' onClick={() => navigate('/astroAssignment')} >Next</Button>
            </div>
          </div>
          </Form>
        </section>
