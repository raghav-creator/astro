          ...
          <div className="content">
            ...
            <div className='right-content'>
              <div className="content-wrap">
                ...
                <form>
                  <div className='form'>
                    <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                      ...
                      &nbsp;
                      <div className='continue-btn'> <Button variant="danger" size="lg" onClick={signClose}>
                        Continue
                ...
                <p className='signEmail-btn'><button onClick={signEmail}>Sign up with Email</button></p>
                <span className='close-btn' onClick={signClose}>X</span>
            </div>
          </div>
        </div>
      </div>
